...
void init_waypoint_region(void)
{
	...
	fp= fopen("//home//yj//waypoints//waypoint_tech.txt","r");
	// fp= fopen("//home//yj//waypoints//waypoint_yntr.txt","r"); 
...
int main(int argc, char **argv)
{
  ...
  //ros::Subscriber sub1 = n.subscribe("/Car_Control_cmd/SteerAngle_Int16",10, &WaySteerControlCallback);
  //ros::Subscriber sub3 = n.subscribe("/Car_Control_cmd/Speed_Float32",10, &WaySteerControlCallback);
